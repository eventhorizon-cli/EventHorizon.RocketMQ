...
// The SDK hosted service starts and stops IRemotingLitePullConsumer.
// LitePullConsumer owns only the sample poll/commit loop.
// Do not manually call IRemotingLitePullConsumer.StartAsync or StopAsync from this Host application.
