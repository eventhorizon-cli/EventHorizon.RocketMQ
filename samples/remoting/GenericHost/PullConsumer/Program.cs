...
{
    options.GroupName = "remoting-sample-pull-consumer";
...
// The SDK hosted service starts and stops IRemotingPullConsumer. PullConsumer owns only the sample pull/commit loop.
// Do not manually call IRemotingPullConsumer.StartAsync or StopAsync from this Host application.
