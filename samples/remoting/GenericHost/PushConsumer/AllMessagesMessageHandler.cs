...
internal sealed class AllMessagesMessageHandler(
    ILogger<AllMessagesMessageHandler> logger) : IRemotingPushMessageHandler
{
        ...
        CancellationToken cancellationToken)
    {
        foreach (var message in messages)
        {
            logger.LogInformation(
                "All-messages consumer received {MessageId} from {Topic}/{BrokerName}/{QueueId} " +
