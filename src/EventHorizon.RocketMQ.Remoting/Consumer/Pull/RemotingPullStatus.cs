...
public enum RemotingPullStatus
{
    ...
    /// <summary>
    /// No newer messages were available at the requested offset.
    /// </summary>
    NoNewMessage,

    /// <summary>
    /// Messages were available, but none matched the subscription filter.
    /// </summary>
    NoMatchedMessage,

    /// <summary>
    /// The requested offset was outside the queue's valid range.
    /// </summary>
    OffsetIllegal
}
