...
internal sealed class PopMessageRequestHeader : CommandCustomHeader
{
    ...
    public long BornTime { get; init; }
    public int InitMode { get; init; }
    public string ExpType { get; init; } = "TAG";
