...
internal sealed class BroadcastOffsetStore
{
    ...
    public async Task<long?> ReadAsync(RemotingConsumerQueue queue, CancellationToken cancellationToken)
    {
    ...
    public Task UpdateAsync(RemotingConsumerQueue queue, long offset, CancellationToken cancellationToken) =>
    ...
    {
        public static OffsetKey Create(RemotingConsumerQueue queue) =>
