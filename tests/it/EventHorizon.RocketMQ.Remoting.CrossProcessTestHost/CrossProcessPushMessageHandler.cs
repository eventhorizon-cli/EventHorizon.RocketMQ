...
internal sealed class CrossProcessPushMessageHandler(CrossProcessHostEventWriter eventWriter)
    : IRemotingPushMessageHandler
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        {
            await eventWriter.WriteDeliveryAsync(message, cancellationToken).ConfigureAwait(false);
        }
