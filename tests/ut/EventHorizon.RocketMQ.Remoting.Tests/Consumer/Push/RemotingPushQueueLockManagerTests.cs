...
{
    [Fact]
    public async Task LockAsync_MapsBrokerGrantAndUsesNamespacedWireIdentity()
    {
        ...
        var first = new RemotingPullMessageQueue("orders", 0, "broker-a", "127.0.0.1:10911");
        var granted = new RemotingPullMessageQueue("orders", 1, "broker-a", "127.0.0.1:10911");
    ...
    [Fact]
    public async Task LockAsync_ContinuesAfterOneBrokerFailsAndDoesNotRefreshItsQueues()
    {
        var cancellationToken = TestContext.Current.CancellationToken;
        ...
        var manager = CreateManager(remoting.Object);
        var failed = new RemotingPullMessageQueue("orders", 0, "broker-a", "127.0.0.1:10911");
        var healthy = new RemotingPullMessageQueue("payments", 0, "broker-b", "127.0.0.1:10921");
    ...
    [Fact]
    public async Task UnlockAsync_WhenOneway_GroupsQueuesAndUsesNamespacedWireIdentity()
    {
        var cancellationToken = TestContext.Current.CancellationToken;
        ...
        var manager = CreateManager(remoting.Object);
        var first = new RemotingPullMessageQueue("orders", 0, "broker-a", "127.0.0.1:10911");
        var second = new RemotingPullMessageQueue("payments", 1, "broker-a", "127.0.0.1:10911");
